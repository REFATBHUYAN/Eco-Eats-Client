...
const ErrorPage = () => {
  ...
  return (
    ...
    <div className="text-center items-center">
      ...
      <h1 className="mt-4 text-3xl font-bold tracking-tight text-red-500 sm:text-5xl">Error: 404</h1>
      <p className="mt-4 text-base leading-7 text-gray-600">Sorry, we couldn’t find the page you’re looking for.</p>
      <div className="mt-12 flex items-center justify-center gap-x-6">
        <a
          href="/"
          className="py-2 px-3 rounded-lg bg-red-500 hover:bg-red-600 active:bg-red-700 ease-in duration-75 text-sm font-semibold text-white flex items-center gap-2"
        >
