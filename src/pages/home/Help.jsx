...
আমরা আছি সকাল ১০ টা থেকে রাত ৮ টা পর্যন্ত আপনার সেবায়।
              ...
              <a href="tel:+8801753 492987"
                  target="_blank" className="bg-green-600 hover:bg-green-700 border-0 capitalize rounded-[10px] px-5 py-2 text-sm font-semibold text-white shadow-sm flex gap-2 items-center justify-center ">
