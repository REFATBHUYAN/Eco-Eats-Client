      ...
      <div id="help" className="my-28 hero min-h-[300px] rounded-lg bg-white bg-[url('/ecoeats/banner/cta-banner.jpg')]">
          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-[670px] flex flex-col justify-center items-center">
              ...
              যেকোন জিজ্ঞাসা ও অর্ডারজনিত সমস্যায় কল করুন আমাদের হেল্পলাইনে অথবা নক করুন আমাদের হোয়াটসঅ্যাপ বা ফেসবুক পেজে। আমরা আছি সকাল ১০ টা থেকে রাত ৮ টা পর্যন্ত আপনার সেবায়।
              </p>
              <div className="flex gap-2">
                ...
                <a target="_blank" href="https://wa.me/+8801753492987" className="rounded-lg cursor-pointer bg-teal-600 hover:bg-teal-700 active:bg-teal-800 active:scale-95 ease-in duration-75 px-3 py-3 text-md font-semibold text-white flex gap-2 items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-whatsapp" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 21l1.65 -3.8a9 9 0 1 1 3.4 2.9l-5.05 .9" /><path d="M9 10a.5 .5 0 0 0 1 0v-1a.5 .5 0 0 0 -1 0v1a5 5 0 0 0 5 5h1a.5 .5 0 0 0 0 -1h-1a.5 .5 0 0 0 0 1" /></svg>
                </a>
                <a target="_blank" href="https://m.me/ecoeatsbangladesh" className="rounded-lg cursor-pointer bg-blue-600 hover:bg-blue-700 active:bg-blue-800 active:scale-95 ease-in duration-75 px-3 py-3 text-md font-semibold text-white flex gap-2 items-center justify-center">
