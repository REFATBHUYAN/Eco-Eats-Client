        ...
        <div className="w-full mx-auto flex-auto">
          ...
          <div className="mt-10 flex flex-col gap-4">
            ...
            <div className="flex gap-2">
              ...
              <a target="_blank" href="https://wa.me/+8801753492987" className="rounded-lg cursor-pointer bg-teal-500 hover:bg-teal-600 active:bg-teal-700 active:scale-95 ease-in duration-75 px-3 py-3 text-md font-semibold text-white flex gap-2 items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-whatsapp" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 21l1.65 -3.8a9 9 0 1 1 3.4 2.9l-5.05 .9" /><path d="M9 10a.5 .5 0 0 0 1 0v-1a.5 .5 0 0 0 -1 0v1a5 5 0 0 0 5 5h1a.5 .5 0 0 0 0 -1h-1a.5 .5 0 0 0 0 1" /></svg>
              </a>
              <a href="tel:+8801753492987" className="rounded-lg cursor-pointer bg-blue-500 hover:bg-blue-600 active:bg-blue-700 active:scale-95 ease-in duration-75 px-3 py-3 text-md font-semibold text-white flex gap-2 items-center justify-center">
