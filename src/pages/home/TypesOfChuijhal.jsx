...
const reasons1 = [
  ...
  " গাছ চুইঝাল সাধারণত রান্নায় গলে যায় না, আস্ত  অবস্থায় থাকে",
  ...
  return (
    <div id="difference" className="my-28 w-full">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div>
          <h1 className="font-semibold hidden md:block text-lg text-left md:text-right mb-3">গাছ চুইঝাল</h1>
          <div className="flex flex-col md:flex-row gap-4">
            <img
              className="md:w-72 w-full  rounded-md aspect-auto "
              src="/ecoeats/product/product-gach-chui.jpg"
              alt=""
            />
            <h1 className="font-semibold md:hidden block text-lg text-left md:text-right ">
              গাছ চুইঝাল
            </h1>
            <div className="md:w-80 w-full">
              {reasons1.map((reason) => (
                <div className="text-left md:text-right py-2 border-y-[1px] border-gray-200">
                  {reason}
                </div>
              ))}
            </div>
        ...
        <div>
          <h1 className="font-semibold hidden md:block text-lg text-left mb-3">এটো চুইঝাল</h1>
          <div className="flex flex-col md:flex-row gap-4">
            <img
              className="md:w-72 md:hidden block  w-full rounded-md aspect-auto "
              src="/ecoeats/product/product-eto-chui.jpg"
              alt=""
            />
            <h1 className="font-semibold md:hidden block text-lg text-left">এটো চুইঝাল</h1>
            <div className="md:w-80 w-full">
              {reasons2.map((reason) => (
                <div className="text-left py-2 border-y-[1px] border-gray-200">
                  {reason}
                </div>
              ))}
            </div>
            <img
              className="md:w-72 hidden md:block  w-full rounded-md aspect-auto "
              src="/ecoeats/product/product-eto-chui.jpg"
              alt=""
            />
          </div>
