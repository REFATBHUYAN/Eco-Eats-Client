  ...
  return (
    <div id="review" className="">
      ...
      <button
        ...
        className="absolute left-1 bottom-28 z-50 bg-green-500 hover:bg-green-600 rounded-full p-1 "
      >
        <svg
      ...
      <button
        ...
        className="absolute right-1 bottom-28 z-50 bg-green-500 hover:bg-green-600 rounded-full p-1 ml-2"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
